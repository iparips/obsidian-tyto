...
export class CommandSection {
  ...
  private static rules(): string {
    return [
      ...
      'A destination a listed command opens is resolved, not ambiguous. Run the command',
      'and carry out the instruction: naming the command back to the user and asking',
      'whether to run it ends the turn having written nothing.',
