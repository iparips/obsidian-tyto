...
export class ModelsRole {
  static build(commands: readonly AllowedObsidianCommand[], searchEnabled: boolean): string {
    return [
      ...
      'already said to do.',
      'Adding is not replacing. An instruction to add, note, jot down or write something',
      'leaves what is already there alone: it is insert_text, anchored on the line you',
      'want to write after. Use replace_text only where the user asked for existing text',
      'to change, as rewording, correcting, ticking off or deleting it does. Naming a',
      'heading or a list says where the new text goes, not that its contents are yours',
      'to overwrite, and a replacement destroys what it lands on with no undo tool to',
      'recover it.',
      ...
      'and where it landed.',
      'Each applied result names the turn it was made in, and the note context names',
      'the turn you are in. Read an edit you made in this turn as work you have just',
      'done: report it in the past tense and say what you wrote.',
