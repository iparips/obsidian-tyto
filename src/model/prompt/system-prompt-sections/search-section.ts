...
export class SearchSection {
  ...
  private static rules(): string {
    return [
      ...
      '- Four wildcards and no others: * within one name, ** across folders, ? one',
      ...
      '- A brace list, {a,b}, is not one of them. It matches those characters, so a',
      '  pattern carrying one asks for a note named with braces and can only miss.',
      '  Send a call per alternative, or widen with * or **.',
