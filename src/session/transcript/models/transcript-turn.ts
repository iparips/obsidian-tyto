...
export class TranscriptTurn {
  ...
  static allPanelSteps(entries: readonly Entry[]): PanelStep[] {
  ...
  static split(entries: readonly Entry[]): TranscriptTurn[] {
  ...
  private static plus(turn: TranscriptTurn, entry: Entry): TranscriptTurn {
