...
Covers release 2 of [2-plan.md](../plan/releases.md): the Desktop MVP loop running on iOS and Android. This is a delta design; everything not listed here carries over from [1-desktop-mvp.md](1-desktop-mvp.md) unchanged (FR32). Batch transcription is plain REST, so no auth changes are needed.
