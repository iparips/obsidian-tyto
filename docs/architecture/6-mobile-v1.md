...
Covers release 6 of [2-plan.md](../plan/releases.md): streaming on mobile via ephemeral tokens, graceful fallback, mic lifecycle, and the public release. Delta design on top of [5-desktop-v1.md](5-desktop-v1.md).
