...
Covers release 5 of [2-plan.md](../plan/plan.md): realtime streaming capture, the OpenAI provider, review-first mode, and the remaining settings. Delta design on top of [1-desktop-mvp.md](1-desktop-mvp.md).
