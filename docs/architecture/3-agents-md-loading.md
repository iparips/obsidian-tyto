...
Covers release 3 of [2-plan.md](../plan/releases.md): standing instructions a folder sets for the notes inside it. Delta design on top of [2-mobile-mvp.md](2-mobile-mvp.md). Requirement IDs refer to [3-agents-md-loading/2-functional-requirements.md](../spec/3-archived/3-agents-md-loading/3-functional-requirements.md).
