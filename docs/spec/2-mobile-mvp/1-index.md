...
Implementable spec for release 2 of [2-plan.md](../../plan/releases.md). High-level design: [architecture/2-mobile-mvp.md](../../architecture/2-mobile-mvp.md). A delta on the Desktop MVP; unlisted components are unchanged.
