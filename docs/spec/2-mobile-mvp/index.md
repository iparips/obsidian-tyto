...
- [1-component-changes.md](1-component-changes.md) - command icon, mime type probing, backgrounding, touch targets
- [2-testing-strategy.md](2-testing-strategy.md) - unit deltas, on-device debugging, and the manual device matrix
