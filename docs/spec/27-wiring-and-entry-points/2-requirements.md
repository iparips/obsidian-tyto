...
- [src/engine/engine-factory.ts](../../../src/engine/engine-factory.ts) - the container this spec names
- [src/session/session-builder.ts](../../../src/session/session-builder.ts) - the scope above it
