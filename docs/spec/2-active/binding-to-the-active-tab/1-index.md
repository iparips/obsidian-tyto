...
- [2-requirements.md](2-requirements.md) - the rule, the path that does not follow it, and the scenarios
...
- [5-tasks.md](5-tasks.md) - two commits: widen the types, then stop dropping the event
