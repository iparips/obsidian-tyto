...
Three decisions are open, two of them blocking. The subsystem list is the
folder's whole structure, and whether the release files go decides whether this
is a rewrite or an addition.
