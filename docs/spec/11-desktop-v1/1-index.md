...
Implementable spec for release 5 of [2-plan.md](../../plan/plan.md). High-level design: [architecture/5-desktop-v1.md](../../architecture/5-desktop-v1.md). Delta on the Mobile MVP codebase.
