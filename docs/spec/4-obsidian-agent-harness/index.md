...
- [1-harness-mvp/index.md](1-harness-mvp/index.md) - commands, retargeting and search. Built; the exit test is outstanding.
- [2-settings-command-picker/index.md](2-settings-command-picker/index.md) - finding a command to allow, without knowing its id.

Related specs

- [1-requirements.md](../1-requirements.md) - the single-note baseline this widens
- [3-agents-md-loading/index.md](../3-agents-md-loading/index.md) - per-folder instructions a retargeted note must honour
