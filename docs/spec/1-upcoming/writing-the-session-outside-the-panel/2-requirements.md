...
- [28-not-losing-a-recording](../../3-archived/28-not-losing-a-recording/1-index.md) - the spec that made this reachable, and where the eviction window was named
- [22-session-persistence](../../3-archived/22-session-persistence/2-requirements.md) - why a session is persisted at all, and the eviction this closes
