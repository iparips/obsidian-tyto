...
Implementable spec for release 5 of [2-plan.md](../../../plan/releases.md). This spec is the design; the architecture docs describe shipped code only. Delta on the Mobile MVP codebase.
