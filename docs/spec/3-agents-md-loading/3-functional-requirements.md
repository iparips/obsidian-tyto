...
Numbered requirements for the feature framed in [2-problem-and-goals.md](2-problem-and-goals.md).
...
Decisions taken and questions still open: [6-decisions.md](6-decisions.md).
