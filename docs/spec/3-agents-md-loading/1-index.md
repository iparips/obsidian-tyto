...
Implementable spec for release 3 of [2-plan.md](../../plan/plan.md). High-level design: [architecture/3-agents-md-loading.md](../../architecture/3-agents-md-loading.md). A delta on the
