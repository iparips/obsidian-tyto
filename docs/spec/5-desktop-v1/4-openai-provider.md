...
- Provider parity is asserted by a shared contract test: the same test suite runs against both providers with fetch and WebSocket mocked, so behaviour cannot drift (see [6-testing-strategy.md](6-testing-strategy.md)).
