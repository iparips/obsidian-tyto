...
[harness MVP](../2026-09-03a-harness-mvp/05-component-design.md); unlisted components are
unchanged.
...
(Engine) from [cancelling-a-turn](../2026-09-03e-cancelling-a-turn/1-index.md) is what
...
[tidy-up-chat-panel](../2026-09-03c-tidy-up-chat-panel/2-requirements.md): smaller and
...
- Cancelling itself, which is
  [cancelling-a-turn](../2026-09-03e-cancelling-a-turn/1-index.md). This design consumes
