...
[cancelling-a-turn](../2026-09-03e-cancelling-a-turn/1-index.md), which landed first:
the second commit consumes TurnCancellationController (Engine) to settle a parked
question, and FR29 has no other mechanism.

Depends on [sessions-without-a-note](../2026-09-03d-sessions-without-a-note/1-index.md)
