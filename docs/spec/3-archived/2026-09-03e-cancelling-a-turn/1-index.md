...
A delta on [harness-mvp](../2026-09-03a-harness-mvp/01-index.md), which made a turn long
...
Undo stays out, with [cross-file-skills](../../1-upcoming/2026-09-14a-cross-file-skills/1-index.md).
The vault keeps what a cancelled turn wrote, and the obligation here is to report
that rather than repair it.

[model-chosen-targets](../2026-09-03f-model-chosen-targets/1-index.md) depends on this:
