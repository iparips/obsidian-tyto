...
[session-persistence](../2026-09-07c-session-persistence/2-requirements.md)
...
[session-persistence](../2026-09-07c-session-persistence/1-index.md) is
...
- [session-persistence](../2026-09-07c-session-persistence/2-requirements.md) - where discarding audio on background was deferred, and where WebView eviction is recorded
