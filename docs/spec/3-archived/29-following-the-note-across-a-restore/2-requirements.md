...
[1-desktop-mvp](../../3-archived/1-desktop-mvp/5-settings-ui.md), which said no
implicit rebinding. That decision predates the active-note wiring added in
[7-sessions-without-a-note](../../3-archived/7-sessions-without-a-note/1-index.md),
...
- [9-model-chosen-targets](../../3-archived/9-model-chosen-targets/1-index.md) - how a command moves the target, which is the move being replayed
