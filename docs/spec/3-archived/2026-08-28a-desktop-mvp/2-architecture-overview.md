...
Implements [architecture/1-overview.md](../../../architecture/1-overview.md). This folder is the implementable spec: an agent should build the release from these files without further decisions.

The tree below is the finished shape. Every path exists except `src/skills/`, which [7-implementation-order.md](7-implementation-order.md) covers. Package ownership and the dependency rule: [architecture/1-overview.md](../../../architecture/1-overview.md).
...
views/, and tests in tests/. [architecture/1-overview.md](../../../architecture/1-overview.md)
