...
```text
1 - Notes/Weekly/Week-35/09-17-Thu.md (14 matches):
  lines 3-7 (2 matches): ...# Coffee with John
  tagged #reflection/john/coffee...
  lines 22-24 (1 match): ...John brought the good coffee...
1 - Notes/Weekly/Week-36/09-24-Thu.md (3 matches):
  lines 11-14 (3 matches): ...walked with John to the river...
