...
The session binds to one note at start and never moves (FR2 of the release 1
requirements). Two kinds of instruction fail as a result.
...
[03-functional-requirements.md](03-functional-requirements.md). Decisions and the
questions gating a design are in [04-decisions.md](04-decisions.md).
