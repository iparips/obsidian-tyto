...
Implementable spec for release 2 of [2-plan.md](../../../plan/releases.md). High-level design: [architecture/3-capture.md](../../../architecture/3-capture.md). A delta on the Desktop MVP; unlisted components are unchanged.
