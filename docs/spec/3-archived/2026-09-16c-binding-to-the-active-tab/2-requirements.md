...
- [following-the-note-across-a-restore](../../3-archived/2026-09-14h-following-the-note-across-a-restore/1-index.md) - states the binding rule and fixes the two entry points this one misses
- [recording-a-retarget](../2026-09-16d-recording-a-retarget/1-index.md) - the sibling: this spec fixes when a retarget happens, that one records that it did
