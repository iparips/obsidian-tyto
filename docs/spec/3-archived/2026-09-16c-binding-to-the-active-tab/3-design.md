...
- Recording that a retarget happened, in the transcript, the panel entry list or
  ...
  [recording-a-retarget](../2026-09-16d-recording-a-retarget/1-index.md).
...
- [following-the-note-across-a-restore](../../3-archived/2026-09-14h-following-the-note-across-a-restore/1-index.md) - states the rule and fixes the two entry points this one misses
