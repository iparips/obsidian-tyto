...
React components mounted from Obsidian shells: the ItemView and PluginSettingTab create a React root and render a panel component. Capture and engine components are in [4-component-design.md](4-component-design.md).
...
Documented here for the UI contract; design detail in [4-component-design.md](4-component-design.md).
