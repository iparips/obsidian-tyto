...
Implementable spec for release 1 of [2-plan.md](../../plan/releases.md). High-level design: [architecture/1-desktop-mvp.md](../../architecture/1-desktop-mvp.md). Tech stack: bun, TypeScript, React 19, vitest with happy-dom.
