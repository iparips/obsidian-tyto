...
Choices made in [02-requirements.md](02-requirements.md), and what a design must
...
in [05-component-design.md](05-component-design.md). Search needs no private API:
